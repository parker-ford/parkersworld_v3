    ...
    <div class = "page__content">
        ...
        <div class="page__text__container">
            ...
            <p class="page__body">
                ...
                <img class="page__img" src="../images/posts/06/S_Matrix1.png" alt="Scaling Matrix" />
                
                For example, if we applied this scaling matrix to our object:
                
                <img class="page__img" src="../images/posts/06/S_Matrix2.png" alt="Scaling Matrix" />
            ...
            <p class="page__body">
                Model space is the initial coordinate space in which a 3D model exists. In this space, the position of each vertex is defined only in relation to the other vertices that make up the model, making the object itself the center of its own universe. This space is typically moat important to the person designing the 3D model, as it's where they determine the object's shape, size, and the relative positioning of its vertices. In a real-world example, imagine a teapot. The teapot could be considered in Model space when it is still a drawing in the designer's sketchbook. Here, the designer has laid out the shape of the teapot, the proportions of the spout, the shape of the handle, etc. Because this is the default space for a model, no transformation matrix needs to be applied to it to reach this space. It is its default space.
            </p>

            <img class="page__img" src="../images/posts/06/Model_Space.png" alt="Model Space" width="50%"/>

            <h4 class="page__sub-subtitle">World Space</h4>
            <p class="page__body">
                World space is the coordinate system of the actual virtual world. In world space, an object's vertex coordinates are in relation to the world that it currently exists in. This is somewhat analogous to our real world, where each object has coordinates that define its location within the world. Going back to the previous example, let's say you pick up a teapot from the teapot factory and want to place it in your room. Here, you can think of your room as the world. Once you place your teapot in your room at a certain position and orientation, you have transformed that teapot from model space to world space, as it now has a position within your room. 
                
                <img class="page__img" src="../images/posts/06/World_Space.png" alt="World Space" width="50%"/>
            ...
            <p class="page__body">
                So now that we have a representation of our objects and their positions within our virtual world, our next step is to define how we want to view this world. This process begins by converting everything into eye space, also known as camera space or view space. Eye space is the coordinate system where everything is positioned relative to the viewer, similar to how we perceive the world relative to our eyes. In our teapot example, this would be the teapots position relative to us when we are standing in the room viewing it. In this space, the virtual world is viewed from the camera's perspective. 
                
                <img class="page__img" src="../images/posts/06/View_Space.png" alt="Eye Space" width="50%"/>
            ...
            <p class="page__body">
                ...
                <br>
                <a href="http://www.codinglabs.net/article_world_view_projection_matrix.aspx">World, View and Projection Transformation Matrices - Coding Labs</a>
                <br>
                <a href="https://www.youtube.com/watch?v=U0_ONQQ5ZNM">The Math behind (most) 3D games - Brendan Galea</a>
