<script>
    ...
    const text_content = `
        animation can be done by using window.requestanimationframe    
        requestanimationframe will be called a different amount of times per second based on frame rate
